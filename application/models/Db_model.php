<?php 
	...
	class Db_model extends CI_Model {
		...
		public function save_notification($receiver_id='',$title='',$description='',$image=''){
...
//            exit();
		...
		function update_admin_profile(){
			...
			$this->db->update('shkalah_user' , $save_data); 	
		...
		function update_system_settings(){		
			...
			$this->db->update('shkalah_system_settings' , $save_data); 	
			
			$save_data['description'] = $this->input->post('home-page-seo-title');	
			$this->db->where('type' , 'home-page-seo-title');		
			$this->db->update('shkalah_system_settings' , $save_data);
			
			$save_data['description'] = $this->input->post('stripe_secret_key');	
			$this->db->where('type' , 'stripe_secret_key');		
			$this->db->update('shkalah_system_settings' , $save_data);
			
			$save_data['description'] = $this->input->post('stripe_publish_key');	
			$this->db->where('type' , 'stripe_publish_key');		
			$this->db->update('shkalah_system_settings' , $save_data);
			
			$save_data['description'] = $this->input->post('sub_amount');	
			$this->db->where('type' , 'sub_amount');		
			$this->db->update('shkalah_system_settings' , $save_data);
			$save_data['description'] = $this->input->post('sami_sub_amount');	
			$this->db->where('type' , 'sami_sub_amount');		
			$this->db->update('shkalah_system_settings' , $save_data);
			
			$save_data['description'] = $this->input->post('individual_amount');	
			$this->db->where('type' , 'individual_amount');		
			$this->db->update('shkalah_system_settings' , $save_data);
			$save_data['description'] = $this->input->post('sami_individual_amount');	
			$this->db->where('type' , 'sami_individual_amount');		
			$this->db->update('shkalah_system_settings' , $save_data);
			
			$save_data['description'] = $this->input->post('individual_reservation_amount');	
			$this->db->where('type' , 'individual_reservation_amount');		
			$this->db->update('shkalah_system_settings' , $save_data);
