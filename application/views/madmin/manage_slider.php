<div class="row wrapper page-heading">
    <div class="col-md-12">
    	...
    	<div class="row col-md-12">
         ...
         <div class="">
            <button class="btn btn-primary" onclick="location.href='<?=base_url()."".admin_ctrl()."/add_slider"?>'"><i class="fa fa-plus"></i>&nbsp;<?= $page_title ?></button>
        </div>	
    </div>
                            ...
                            foreach ($table_data as $data) {$i++;
                               ?>
                                <tr class="gradeX row_<?php echo $data['status']; ?>"
                                        ...
                                        <div class="table-toggle">
                                            <div class="toggle-btn1 <?php if ($data['status'] == 'Active') {
                                                ...
                                                <input type="checkbox" class="cb-value"
                                                       value="<?php echo $data['slider_id']; ?>" <?php if ($data['status'] == 'Active') {
                                                    echo 'checked';
                                                } ?>/>
                                    ...
                                    <td class="center">
                                        <a href="<?=base_url().admin_ctrl().'/edit_slider/'.$data['slider_id']; ?>">
                                            <img src="<?=base_url(); ?>assets/admin/img/edit.png" class="mr_1" /> 
                                        </a>
                                        <a href="javascript:;"
                                           onclick="confirm_modal_action('<?php echo base_url() . admin_ctrl() ?>/<?= $page_name ?>/delete/<?php echo $data['slider_id']; ?>');">
