         ...
         <div class="col-sm-6 col-md-6 col-lg-6">
                <form role="form" method="post"
                    ...
                    <div class="row input-container">
                        ...
                        <div class="row col-md-12">
                            <input type="text"
                               placeholder="Enter your skills in English"
                               name="en_name"
                    ...
                    <div class="row input-container">
                        <label class=""><?= get_phrase("name") ?>(مهارات)</label>
                        <div class="row col-md-12">
                        <input type="text"
                               placeholder="أدخل مهاراتك في اللغة العربية"
                               name="ar_name"
                               value="<?php echo $edit_data['ar_name'];?>"
                               class="form-control col-md-12" required>
                        </div>
                    </div>
