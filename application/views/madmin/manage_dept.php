                ...
                <div class="">
                    <div class="table-responsive">
                        <table class="dataTables-example table-striped">
                            ...
                            <tr>
                                <th><?="No."?></th>
                                <th><?=get_phrase("department_name")?></th>
                            ...
                            foreach ($table_data as $data) {$i++; ?>
                                <tr class="gradeX row_<?php echo $data['status']; ?>"
                                        ...
                                        <div class="table-toggle">
                                            <div class="toggle-btn1 <?php if ($data['status'] == 'Active') {
                                                ...
                                                <input type="checkbox" class="cb-value"
                                                       value="<?php echo $data['dept_id']; ?>" <?php if ($data['status'] == 'Active') {
                                                    echo 'checked';
                                                } ?>/>
                                    ...
                                    <td class="center">
                                        <a href="<?=base_url().admin_ctrl().'/edit_dept/'.$data['dept_id']; ?>">
                                            <img src="<?=base_url(); ?>assets/admin/img/edit.png" class="mr_1" /> 
                                        </a>
                                        <!--<a href="javascript:;"-->
                                        <!--   onclick="confirm_modal_action('<?php echo base_url() . admin_ctrl() ?>/<?= $page_name ?>/delete/<?php echo $data['dept_id']; ?>');">-->
