 <?php 
    ...
    ?>
<?php $system_image = $this->db->get_where('shkalah_system_settings',array('type'=>'system_image'))->row()->description;
$system_name = $this->db->get_where('shkalah_system_settings',array('type'=>'system_name'))->row()->description;
?>
<!DOCTYPE html>
<html lang="en">
