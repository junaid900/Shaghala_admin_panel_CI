    ...
    <div>
        <div class="col-sm-6 col-md-6 col-lg-6">
            <form role="form" method="post" action="<?= base_url() . admin_ctrl() . "/" . $page_name . "/save" ?>" enctype="multipart/form-data">
                ...
                <div>
                    <h4 class=""><?=get_phrase("title")?>:</h4>
                </div>
                
                <div class="row input-container">
                    
                        <input type="text" placeholder="<?=get_phrase("slider_title")?>" name="title" class="form-control col-md-12" required>
                ...
                <div class="row input-container">
                        ...
                        <input type="text" placeholder="<?=get_phrase("hyperlink")?>" name="hyperlink" class="form-control col-md-12" required>
